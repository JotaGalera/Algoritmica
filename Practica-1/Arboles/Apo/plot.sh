...
#Variables:
OUTPUT=./data/grafica_tiempo_average_case_usoapo.png
TITULO="Algoritmo APO Average Case"
XLABEL="Longitud del Vector"
YLABEL="Tiempo (segundos)"
LEYENDA="Algoritmo APO O(n*log(n))"
FICHERO_DATOS="./data/tiempo_average_case_usoapo.dat"
COLOR=blue
